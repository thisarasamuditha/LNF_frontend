...
import { Tag, Camera, MapPin, Calendar } from "lucide-react";
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-3">
              ...
              <div>
                ...
                <p className="text-xs text-muted-foreground">Report Lost Item</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <Card className="max-w-2xl mx-auto rounded-2xl">
          <CardHeader className="text-center">
            ...
            <p className="text-gray-600">
              ...
              to help you report lost items with all the necessary details.
            </p>
          </CardHeader>
          <CardContent className="space-y-6">
            ...
            <div className="space-y-4">
              <div>
                ...
                <Input placeholder="e.g., Black iPhone 14" disabled className="rounded-xl" />
              </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                  ...
                  <div className="relative">
                    ...
                    <Input placeholder="Central Library" disabled className="pl-10 rounded-xl" />
                  </div>
                </div>
              ...
              <Button className="w-full bg-red-600 hover:bg-red-700 rounded-xl py-3" disabled>
